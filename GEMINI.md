...
- 必要に応じて、正確さを確認するために、公式ドキュメントや信頼できるリソースを複数参照してください。
  - 適切に検索エンジンを使用して、関連する情報を参照してください。
...
- このリポジトリではテストを利用できます
  ...
  - テストは、playwright を使用して実装されています。追加する場合、各テストの名称は日本語で実装してください。
  - テストの追加や修正は、既存のテストコードを参考にしてください。

- 任意の MCP も利用可能です。
  - `.vscode/mcp.json`を参照して、利用してください。
