...
- お気に入りイベントは履歴ページ（/history）で一覧表示され、クリックでイベント詳細ページに遷移できる。
...
- 履歴ページ（/history）に「お気に入りイベント」一覧セクションを表示。
  - タイトル・最終アクセス日時を表示。
  - クリックでイベント詳細ページへ遷移。
...
- `/src/app/history/page.tsx`（Providerラップ・一覧表示）

---

本仕様は履歴ページのUX向上のための「お気に入りイベント」機能の実装内容を反映しています。
